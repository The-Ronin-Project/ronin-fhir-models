...
public class CapabilityStatement_Interaction {
     ...
     */
    @JsonProperty("code")
    @JsonPropertyDescription("Coded identifier of the operation, supported by the system resource.")
    private CapabilityStatement_Interaction.Code code;
    /**
     ...
     */
    @JsonProperty("code")
    public CapabilityStatement_Interaction.Code getCode() {
        return code;
    }
     ...
     */
    @JsonProperty("code")
    public void setCode(CapabilityStatement_Interaction.Code code) {
        this.code = code;
    }
    ...
    public String toString() {
        ...
        sb.append(CapabilityStatement_Interaction.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CapabilityStatement_Interaction) == false) {
            return false;
        }
        CapabilityStatement_Interaction rhs = ((CapabilityStatement_Interaction) other);
    ...
    public enum Code {
        ...
        private final static Map<String, CapabilityStatement_Interaction.Code> CONSTANTS = new HashMap<String, CapabilityStatement_Interaction.Code>();

        static {
            for (CapabilityStatement_Interaction.Code c: values()) {
        ...
        @JsonCreator
        public static CapabilityStatement_Interaction.Code fromValue(String value) {
            CapabilityStatement_Interaction.Code constant = CONSTANTS.get(value);
            if (constant == null) {
