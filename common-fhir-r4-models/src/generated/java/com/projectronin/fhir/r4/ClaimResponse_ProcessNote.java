...
public class ClaimResponse_ProcessNote {
    ...
    private ClaimResponse_ProcessNote.Type type;
    /**
     * Base definition for all elements in a resource.
     * 
     */
     ...
     */
    @JsonProperty("type")
    public ClaimResponse_ProcessNote.Type getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(ClaimResponse_ProcessNote.Type type) {
        this.type = type;
    }
    ...
    public String toString() {
        ...
        sb.append(ClaimResponse_ProcessNote.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ClaimResponse_ProcessNote) == false) {
            return false;
        }
        ClaimResponse_ProcessNote rhs = ((ClaimResponse_ProcessNote) other);
    ...
    public enum Type {
        ...
        private final static Map<String, ClaimResponse_ProcessNote.Type> CONSTANTS = new HashMap<String, ClaimResponse_ProcessNote.Type>();

        static {
            for (ClaimResponse_ProcessNote.Type c: values()) {
        ...
        @JsonCreator
        public static ClaimResponse_ProcessNote.Type fromValue(String value) {
            ClaimResponse_ProcessNote.Type constant = CONSTANTS.get(value);
            if (constant == null) {
