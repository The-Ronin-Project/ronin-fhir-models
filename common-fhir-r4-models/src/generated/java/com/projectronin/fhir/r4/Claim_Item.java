...
public class Claim_Item {
    ...
    @JsonPropertyDescription("CareTeam members related to this service or product.")
    ...
    @JsonPropertyDescription("Diagnosis applicable for this service or product.")
    ...
    @JsonPropertyDescription("The Encounters during which this Claim was created or to which the creation of this record is tightly associated.")
     ...
     */
    @JsonProperty("detail")
    @JsonPropertyDescription("A claim detail line. Either a simple (a product or service) or a 'group' of sub-details which are simple items.")
    private List<Claim_Detail> detail = new ArrayList<Claim_Detail>();
     ...
     */
    @JsonProperty("detail")
    public List<Claim_Detail> getDetail() {
        return detail;
    }
     ...
     */
    @JsonProperty("detail")
    public void setDetail(List<Claim_Detail> detail) {
        this.detail = detail;
    }
    ...
    public String toString() {
        ...
        sb.append(Claim_Item.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
