...
public class ClaimResponse_AddItem {
    ...
    @JsonPropertyDescription("The sequence number of the sub-details within the details within the claim item which this line is intended to replace.")
    ...
    private List<ClaimResponse_Detail1> detail = new ArrayList<ClaimResponse_Detail1>();
     ...
     */
    @JsonProperty("detail")
    public List<ClaimResponse_Detail1> getDetail() {
        return detail;
    }
     ...
     */
    @JsonProperty("detail")
    public void setDetail(List<ClaimResponse_Detail1> detail) {
        this.detail = detail;
    }
    ...
    public String toString() {
        ...
        sb.append(ClaimResponse_AddItem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
