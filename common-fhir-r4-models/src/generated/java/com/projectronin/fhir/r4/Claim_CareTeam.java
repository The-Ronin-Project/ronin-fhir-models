...
public class Claim_CareTeam {
    ...
    public String toString() {
        ...
        sb.append(Claim_CareTeam.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim_CareTeam) == false) {
            return false;
        }
        Claim_CareTeam rhs = ((Claim_CareTeam) other);
