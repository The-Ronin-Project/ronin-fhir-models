...
public class ExplanationOfBenefit_SubDetail {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_SubDetail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_SubDetail) == false) {
            return false;
        }
        ExplanationOfBenefit_SubDetail rhs = ((ExplanationOfBenefit_SubDetail) other);
