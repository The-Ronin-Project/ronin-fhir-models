...
public class Measure_Component {
    ...
    public String toString() {
        ...
        sb.append(Measure_Component.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Measure_Component) == false) {
            return false;
        }
        Measure_Component rhs = ((Measure_Component) other);
