    ...
    extends DomainResource
{
    ...
    @JsonPropertyDescription("This is a EffectEvidenceSynthesis resource")
    ...
    @JsonPropertyDescription("A formal identifier that is used to identify this effect evidence synthesis when it is represented in other formats, or referenced in a specification, model, design or an instance.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of this effect evidence synthesis. Enables tracking the life-cycle of the content.")
    private EffectEvidenceSynthesis.Status status;
    /**
     * Base definition for all elements in a resource.
     * 
     */
    ...
    @JsonPropertyDescription("The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate effect evidence synthesis instances.")
    ...
    @JsonPropertyDescription("A legal or geographic region in which the effect evidence synthesis is intended to be used.")
     ...
     */
    @JsonProperty("topic")
    @JsonPropertyDescription("Descriptive topics related to the content of the EffectEvidenceSynthesis. Topics provide a high-level categorization grouping types of EffectEvidenceSynthesiss that can be useful for filtering and searching.")
    ...
    @JsonPropertyDescription("The EffectEvidenceSynthesis resource describes the difference in an outcome between exposures states in a population where the effect estimate is derived from a combination of research studies.")
    private EffectEvidenceSynthesis_SampleSize sampleSize;
    /**
     * A description of the results for each exposure considered in the effect estimate.
     * 
     */
    @JsonProperty("resultsByExposure")
    @JsonPropertyDescription("A description of the results for each exposure considered in the effect estimate.")
    private List<EffectEvidenceSynthesis_ResultsByExposure> resultsByExposure = new ArrayList<EffectEvidenceSynthesis_ResultsByExposure>();
    /**
     * The estimated effect of the exposure variant.
     * 
     */
    @JsonProperty("effectEstimate")
    @JsonPropertyDescription("The estimated effect of the exposure variant.")
    private List<EffectEvidenceSynthesis_EffectEstimate> effectEstimate = new ArrayList<EffectEvidenceSynthesis_EffectEstimate>();
    /**
     * A description of the certainty of the effect estimate.
     * 
     */
    @JsonProperty("certainty")
    @JsonPropertyDescription("A description of the certainty of the effect estimate.")
    private List<EffectEvidenceSynthesis_Certainty> certainty = new ArrayList<EffectEvidenceSynthesis_Certainty>();
    @JsonIgnore
     ...
     */
    @JsonProperty("status")
    public EffectEvidenceSynthesis.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(EffectEvidenceSynthesis.Status status) {
        this.status = status;
    }
     ...
     */
    @JsonProperty("sampleSize")
    public EffectEvidenceSynthesis_SampleSize getSampleSize() {
        return sampleSize;
    }
     ...
     */
    @JsonProperty("sampleSize")
    public void setSampleSize(EffectEvidenceSynthesis_SampleSize sampleSize) {
     ...
     */
    @JsonProperty("resultsByExposure")
    public List<EffectEvidenceSynthesis_ResultsByExposure> getResultsByExposure() {
     ...
     */
    @JsonProperty("resultsByExposure")
    public void setResultsByExposure(List<EffectEvidenceSynthesis_ResultsByExposure> resultsByExposure) {
     ...
     */
    @JsonProperty("effectEstimate")
    public List<EffectEvidenceSynthesis_EffectEstimate> getEffectEstimate() {
     ...
     */
    @JsonProperty("effectEstimate")
    public void setEffectEstimate(List<EffectEvidenceSynthesis_EffectEstimate> effectEstimate) {
     ...
     */
    @JsonProperty("certainty")
    public List<EffectEvidenceSynthesis_Certainty> getCertainty() {
        return certainty;
    }
     ...
     */
    @JsonProperty("certainty")
    public void setCertainty(List<EffectEvidenceSynthesis_Certainty> certainty) {
    ...
    public String toString() {
        ...
        sb.append(EffectEvidenceSynthesis.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("exposureAlternative");
        sb.append('=');
        sb.append(((this.exposureAlternative == null)?"<null>":this.exposureAlternative));
        sb.append(',');
        sb.append("outcome");
        sb.append('=');
        ...
        sb.append(',');
        sb.append("resultsByExposure");
        sb.append('=');
        sb.append(((this.resultsByExposure == null)?"<null>":this.resultsByExposure));
        sb.append(',');
        sb.append("effectEstimate");
        sb.append('=');
        sb.append(((this.effectEstimate == null)?"<null>":this.effectEstimate));
        sb.append(',');
        sb.append("certainty");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.exposureAlternative == null)? 0 :this.exposureAlternative.hashCode()));
        ...
        result = ((result* 31)+((this.resultsByExposure == null)? 0 :this.resultsByExposure.hashCode()));
        ...
        result = ((result* 31)+((this.effectEstimate == null)? 0 :this.effectEstimate.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof EffectEvidenceSynthesis) == false) {
            return false;
        }
        EffectEvidenceSynthesis rhs = ((EffectEvidenceSynthesis) other);
        return ((((((((((((((((((((((((((((((((((((((((((((((super.equals(rhs)&&((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date))))&&((this.note == rhs.note)||((this.note!= null)&&this.note.equals(rhs.note))))&&((this.copyright == rhs.copyright)||((this.copyright!= null)&&this.copyright.equals(rhs.copyright))))&&((this._approvalDate == rhs._approvalDate)||((this._approvalDate!= null)&&this._approvalDate.equals(rhs._approvalDate))))&&((this.approvalDate == rhs.approvalDate)||((this.approvalDate!= null)&&this.approvalDate.equals(rhs.approvalDate))))&&((this._name == rhs._name)||((this._name!= null)&&this._name.equals(rhs._name))))&&((this.jurisdiction == rhs.jurisdiction)||((this.jurisdiction!= null)&&this.jurisdiction.equals(rhs.jurisdiction))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this.sampleSize == rhs.sampleSize)||((this.sampleSize!= null)&&this.sampleSize.equals(rhs.sampleSize))))&&((this._copyright == rhs._copyright)||((this._copyright!= null)&&this._copyright.equals(rhs._copyright))))&&((this.exposureAlternative == rhs.exposureAlternative)||((this.exposureAlternative!= null)&&this.exposureAlternative.equals(rhs.exposureAlternative))))&&((this.studyType == rhs.studyType)||((this.studyType!= null)&&this.studyType.equals(rhs.studyType))))&&((this.contact == rhs.contact)||((this.contact!= null)&&this.contact.equals(rhs.contact))))&&((this.endorser == rhs.endorser)||((this.endorser!= null)&&this.endorser.equals(rhs.endorser))))&&((this._url == rhs._url)||((this._url!= null)&&this._url.equals(rhs._url))))&&((this._description == rhs._description)||((this._description!= null)&&this._description.equals(rhs._description))))&&((this._version == rhs._version)||((this._version!= null)&&this._version.equals(rhs._version))))&&((this.outcome == rhs.outcome)||((this.outcome!= null)&&this.outcome.equals(rhs.outcome))))&&((this.identifier == rhs.identifier)||((this.identifier!= null)&&this.identifier.equals(rhs.identifier))))&&((this.editor == rhs.editor)||((this.editor!= null)&&this.editor.equals(rhs.editor))))&&((this.resultsByExposure == rhs.resultsByExposure)||((this.resultsByExposure!= null)&&this.resultsByExposure.equals(rhs.resultsByExposure))))&&((this.relatedArtifact == rhs.relatedArtifact)||((this.relatedArtifact!= null)&&this.relatedArtifact.equals(rhs.relatedArtifact))))&&((this._date == rhs._date)||((this._date!= null)&&this._date.equals(rhs._date))))&&((this.effectivePeriod == rhs.effectivePeriod)||((this.effectivePeriod!= null)&&this.effectivePeriod.equals(rhs.effectivePeriod))))&&((this.author == rhs.author)||((this.author!= null)&&this.author.equals(rhs.author))))&&((this._title == rhs._title)||((this._title!= null)&&this._title.equals(rhs._title))))&&((this.certainty == rhs.certainty)||((this.certainty!= null)&&this.certainty.equals(rhs.certainty))))&&((this.reviewer == rhs.reviewer)||((this.reviewer!= null)&&this.reviewer.equals(rhs.reviewer))))&&((this._status == rhs._status)||((this._status!= null)&&this._status.equals(rhs._status))))&&((this._lastReviewDate == rhs._lastReviewDate)||((this._lastReviewDate!= null)&&this._lastReviewDate.equals(rhs._lastReviewDate))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.population == rhs.population)||((this.population!= null)&&this.population.equals(rhs.population))))&&((this.effectEstimate == rhs.effectEstimate)||((this.effectEstimate!= null)&&this.effectEstimate.equals(rhs.effectEstimate))))&&((this.exposure == rhs.exposure)||((this.exposure!= null)&&this.exposure.equals(rhs.exposure))))&&((this.lastReviewDate == rhs.lastReviewDate)||((this.lastReviewDate!= null)&&this.lastReviewDate.equals(rhs.lastReviewDate))))&&((this.synthesisType == rhs.synthesisType)||((this.synthesisType!= null)&&this.synthesisType.equals(rhs.synthesisType))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.publisher == rhs.publisher)||((this.publisher!= null)&&this.publisher.equals(rhs.publisher))))&&((this.topic == rhs.topic)||((this.topic!= null)&&this.topic.equals(rhs.topic))))&&((this._publisher == rhs._publisher)||((this._publisher!= null)&&this._publisher.equals(rhs._publisher))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.useContext == rhs.useContext)||((this.useContext!= null)&&this.useContext.equals(rhs.useContext))))&&((this.resourceType == rhs.resourceType)||((this.resourceType!= null)&&this.resourceType.equals(rhs.resourceType))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
    ...
    public enum Status {
        ...
        private final static Map<String, EffectEvidenceSynthesis.Status> CONSTANTS = new HashMap<String, EffectEvidenceSynthesis.Status>();

        static {
            for (EffectEvidenceSynthesis.Status c: values()) {
        ...
        @JsonCreator
        public static EffectEvidenceSynthesis.Status fromValue(String value) {
            EffectEvidenceSynthesis.Status constant = CONSTANTS.get(value);
            if (constant == null) {
