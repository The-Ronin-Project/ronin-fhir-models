    ...
    extends DomainResource
{
    ...
    @JsonPropertyDescription("This is a PlanDefinition resource")
    ...
    @JsonPropertyDescription("A formal identifier that is used to identify this plan definition when it is represented in other formats, or referenced in a specification, model, design or an instance.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of this plan definition. Enables tracking the life-cycle of the content.")
    private PlanDefinition.Status status;
    /**
     * Base definition for all elements in a resource.
     * 
     */
    ...
    @JsonPropertyDescription("The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate plan definition instances.")
    ...
    @JsonPropertyDescription("A legal or geographic region in which the plan definition is intended to be used.")
     ...
     */
    @JsonProperty("topic")
    @JsonPropertyDescription("Descriptive topics related to the content of the plan definition. Topics provide a high-level categorization of the definition that can be useful for filtering and searching.")
    ...
    @JsonPropertyDescription("A reference to a Library resource containing any formal logic used by the plan definition.")
     ...
     */
    @JsonProperty("goal")
    @JsonPropertyDescription("Goals that describe what the activities within the plan are intended to achieve. For example, weight loss, restoring an activity of daily living, obtaining herd immunity via immunization, meeting a process improvement objective, etc.")
    private List<PlanDefinition_Goal> goal = new ArrayList<PlanDefinition_Goal>();
    /**
     * An action or group of actions to be taken as part of the plan.
     * 
     */
    @JsonProperty("action")
    @JsonPropertyDescription("An action or group of actions to be taken as part of the plan.")
     ...
     */
    @JsonProperty("status")
    public PlanDefinition.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(PlanDefinition.Status status) {
        this.status = status;
    }
     ...
     */
    @JsonProperty("goal")
    public List<PlanDefinition_Goal> getGoal() {
        return goal;
    }
     ...
     */
    @JsonProperty("goal")
    public void setGoal(List<PlanDefinition_Goal> goal) {
        this.goal = goal;
    }
    ...
    public String toString() {
        ...
        sb.append(PlanDefinition.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public enum Status {
        ...
        private final static Map<String, PlanDefinition.Status> CONSTANTS = new HashMap<String, PlanDefinition.Status>();

        static {
            for (PlanDefinition.Status c: values()) {
        ...
        @JsonCreator
        public static PlanDefinition.Status fromValue(String value) {
            PlanDefinition.Status constant = CONSTANTS.get(value);
            if (constant == null) {
