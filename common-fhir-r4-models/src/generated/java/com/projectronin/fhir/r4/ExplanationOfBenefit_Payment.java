...
public class ExplanationOfBenefit_Payment {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_Payment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        ...
        sb.append('=');
        sb.append(((this.adjustmentReason == null)?"<null>":this.adjustmentReason));
        sb.append(',');
        sb.append("date");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.adjustmentReason == null)? 0 :this.adjustmentReason.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_Payment) == false) {
            return false;
        }
        ExplanationOfBenefit_Payment rhs = ((ExplanationOfBenefit_Payment) other);
        return (((((((((((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date)))&&((this.identifier == rhs.identifier)||((this.identifier!= null)&&this.identifier.equals(rhs.identifier))))&&((this.extension == rhs.extension)||((this.extension!= null)&&this.extension.equals(rhs.extension))))&&((this.adjustmentReason == rhs.adjustmentReason)||((this.adjustmentReason!= null)&&this.adjustmentReason.equals(rhs.adjustmentReason))))&&((this.amount == rhs.amount)||((this.amount!= null)&&this.amount.equals(rhs.amount))))&&((this._date == rhs._date)||((this._date!= null)&&this._date.equals(rhs._date))))&&((this.modifierExtension == rhs.modifierExtension)||((this.modifierExtension!= null)&&this.modifierExtension.equals(rhs.modifierExtension))))&&((this.adjustment == rhs.adjustment)||((this.adjustment!= null)&&this.adjustment.equals(rhs.adjustment))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))));
    }
