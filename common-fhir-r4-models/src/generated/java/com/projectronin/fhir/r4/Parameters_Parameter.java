...
public class Parameters_Parameter {
    ...
    @JsonPropertyDescription("If the parameter is a data type.")
     ...
     */
    @JsonProperty("part")
    @JsonPropertyDescription("A named part of a multi-part parameter.")
    private List<Parameters_Parameter> part = new ArrayList<Parameters_Parameter>();
     ...
     */
    @JsonProperty("part")
    public List<Parameters_Parameter> getPart() {
        return part;
    }
     ...
     */
    @JsonProperty("part")
    public void setPart(List<Parameters_Parameter> part) {
        this.part = part;
    }
    ...
    public String toString() {
        ...
        sb.append(Parameters_Parameter.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
