...
public class Specimen_Processing {
    ...
    @JsonPropertyDescription("Material used in the processing step.")
    ...
    @JsonPropertyDescription("A record of the time or period when the specimen processing occurred.  For example the time of sample fixation or the period of time the sample was in formalin.")
     ...
     */
    @JsonProperty("additive")
    public void setAdditive(List<Reference> additive) {
    ...
    public String toString() {
        ...
        sb.append(Specimen_Processing.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Specimen_Processing) == false) {
            return false;
        }
        Specimen_Processing rhs = ((Specimen_Processing) other);
