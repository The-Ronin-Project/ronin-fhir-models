...
public class ChargeItem_Performer {
    ...
    public String toString() {
        ...
        sb.append(ChargeItem_Performer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ChargeItem_Performer) == false) {
            return false;
        }
        ChargeItem_Performer rhs = ((ChargeItem_Performer) other);
