...
public class ConceptMap_Unmapped {
    ...
    private ConceptMap_Unmapped.Mode mode;
    /**
     ...
     */
    @JsonProperty("mode")
    public ConceptMap_Unmapped.Mode getMode() {
        return mode;
    }
     ...
     */
    @JsonProperty("mode")
    public void setMode(ConceptMap_Unmapped.Mode mode) {
        this.mode = mode;
    }
    ...
    public String toString() {
        ...
        sb.append(ConceptMap_Unmapped.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public enum Mode {
        ...
        private final static Map<String, ConceptMap_Unmapped.Mode> CONSTANTS = new HashMap<String, ConceptMap_Unmapped.Mode>();

        static {
            for (ConceptMap_Unmapped.Mode c: values()) {
        ...
        @JsonCreator
        public static ConceptMap_Unmapped.Mode fromValue(String value) {
            ConceptMap_Unmapped.Mode constant = CONSTANTS.get(value);
            if (constant == null) {
