...
public class Measure_Stratifier {
    ...
    @JsonPropertyDescription("A component of the stratifier criteria for the measure report, specified as either the name of a valid CQL expression defined within a referenced library or a valid FHIR Resource Path.")
    private List<Measure_Component> component = new ArrayList<Measure_Component>();
     ...
     */
    @JsonProperty("component")
    public List<Measure_Component> getComponent() {
        return component;
    }
     ...
     */
    @JsonProperty("component")
    public void setComponent(List<Measure_Component> component) {
    ...
    public String toString() {
        ...
        sb.append(Measure_Stratifier.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
