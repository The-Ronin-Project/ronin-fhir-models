    ...
    extends DomainResource
{
    ...
    @JsonPropertyDescription("This is a ValueSet resource")
    ...
    @JsonPropertyDescription("A formal identifier that is used to identify this value set when it is represented in other formats, or referenced in a specification, model, design or an instance.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of this value set. Enables tracking the life-cycle of the content. The status of the value set applies to the value set definition (ValueSet.compose) and the associated ValueSet metadata. Expansions do not have a state.")
    private ValueSet.Status status;
    /**
     * Base definition for all elements in a resource.
     * 
     */
    ...
    @JsonPropertyDescription("The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate value set instances.")
    ...
    @JsonPropertyDescription("A legal or geographic region in which the value set is intended to be used.")
     ...
     * 
     */
    @JsonProperty("_immutable")
    @JsonPropertyDescription("Base definition for all elements in a resource.")
    private Element _immutable;
    /**
     * A string that may contain Github Flavored Markdown syntax for optional processing by a mark down presentation engine
     * 
     */
    ...
    @JsonPropertyDescription("A ValueSet resource instance specifies a set of codes drawn from one or more code systems, intended for use in a particular context. Value sets link between [[[CodeSystem]]] definitions and their use in [coded elements](terminologies.html).")
    private ValueSet_Compose compose;
    /**
     * A ValueSet resource instance specifies a set of codes drawn from one or more code systems, intended for use in a particular context. Value sets link between [[[CodeSystem]]] definitions and their use in [coded elements](terminologies.html).
     * 
     */
    ...
    @JsonPropertyDescription("A ValueSet resource instance specifies a set of codes drawn from one or more code systems, intended for use in a particular context. Value sets link between [[[CodeSystem]]] definitions and their use in [coded elements](terminologies.html).")
    private ValueSet_Expansion expansion;
    @JsonIgnore
     ...
     */
    @JsonProperty("status")
    public ValueSet.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(ValueSet.Status status) {
        this.status = status;
    }
     ...
     */
    @JsonProperty("_immutable")
    public void set_immutable(Element _immutable) {
     ...
     */
    @JsonProperty("compose")
    public ValueSet_Compose getCompose() {
        return compose;
    }
     ...
     */
    @JsonProperty("compose")
    public void setCompose(ValueSet_Compose compose) {
     ...
     */
    @JsonProperty("expansion")
    public ValueSet_Expansion getExpansion() {
        return expansion;
    }
     ...
     */
    @JsonProperty("expansion")
    public void setExpansion(ValueSet_Expansion expansion) {
    ...
    public String toString() {
        ...
        sb.append(ValueSet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append("immutable");
        sb.append('=');
        sb.append(((this.immutable == null)?"<null>":this.immutable));
        sb.append(',');
        sb.append("_immutable");
        sb.append('=');
        sb.append(((this._immutable == null)?"<null>":this._immutable));
        sb.append(',');
        sb.append("purpose");
        sb.append('=');
        ...
        sb.append("compose");
        sb.append('=');
        sb.append(((this.compose == null)?"<null>":this.compose));
        sb.append(',');
        sb.append("expansion");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.immutable == null)? 0 :this.immutable.hashCode()));
        result = ((result* 31)+((this._immutable == null)? 0 :this._immutable.hashCode()));
        result = ((result* 31)+((this._purpose == null)? 0 :this._purpose.hashCode()));
        result = ((result* 31)+((this.compose == null)? 0 :this.compose.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ValueSet) == false) {
            return false;
        }
        ValueSet rhs = ((ValueSet) other);
        return ((((((((((((((((((((((((((((((((super.equals(rhs)&&((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date))))&&((this.copyright == rhs.copyright)||((this.copyright!= null)&&this.copyright.equals(rhs.copyright))))&&((this._name == rhs._name)||((this._name!= null)&&this._name.equals(rhs._name))))&&((this._experimental == rhs._experimental)||((this._experimental!= null)&&this._experimental.equals(rhs._experimental))))&&((this.purpose == rhs.purpose)||((this.purpose!= null)&&this.purpose.equals(rhs.purpose))))&&((this.jurisdiction == rhs.jurisdiction)||((this.jurisdiction!= null)&&this.jurisdiction.equals(rhs.jurisdiction))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.experimental == rhs.experimental)||((this.experimental!= null)&&this.experimental.equals(rhs.experimental))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this._copyright == rhs._copyright)||((this._copyright!= null)&&this._copyright.equals(rhs._copyright))))&&((this.contact == rhs.contact)||((this.contact!= null)&&this.contact.equals(rhs.contact))))&&((this._url == rhs._url)||((this._url!= null)&&this._url.equals(rhs._url))))&&((this._description == rhs._description)||((this._description!= null)&&this._description.equals(rhs._description))))&&((this._version == rhs._version)||((this._version!= null)&&this._version.equals(rhs._version))))&&((this.identifier == rhs.identifier)||((this.identifier!= null)&&this.identifier.equals(rhs.identifier))))&&((this._date == rhs._date)||((this._date!= null)&&this._date.equals(rhs._date))))&&((this._title == rhs._title)||((this._title!= null)&&this._title.equals(rhs._title))))&&((this._status == rhs._status)||((this._status!= null)&&this._status.equals(rhs._status))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.expansion == rhs.expansion)||((this.expansion!= null)&&this.expansion.equals(rhs.expansion))))&&((this.immutable == rhs.immutable)||((this.immutable!= null)&&this.immutable.equals(rhs.immutable))))&&((this._immutable == rhs._immutable)||((this._immutable!= null)&&this._immutable.equals(rhs._immutable))))&&((this._purpose == rhs._purpose)||((this._purpose!= null)&&this._purpose.equals(rhs._purpose))))&&((this.compose == rhs.compose)||((this.compose!= null)&&this.compose.equals(rhs.compose))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.publisher == rhs.publisher)||((this.publisher!= null)&&this.publisher.equals(rhs.publisher))))&&((this._publisher == rhs._publisher)||((this._publisher!= null)&&this._publisher.equals(rhs._publisher))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.useContext == rhs.useContext)||((this.useContext!= null)&&this.useContext.equals(rhs.useContext))))&&((this.resourceType == rhs.resourceType)||((this.resourceType!= null)&&this.resourceType.equals(rhs.resourceType))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
    ...
    public enum Status {
        ...
        private final static Map<String, ValueSet.Status> CONSTANTS = new HashMap<String, ValueSet.Status>();

        static {
            for (ValueSet.Status c: values()) {
        ...
        @JsonCreator
        public static ValueSet.Status fromValue(String value) {
            ValueSet.Status constant = CONSTANTS.get(value);
            if (constant == null) {
