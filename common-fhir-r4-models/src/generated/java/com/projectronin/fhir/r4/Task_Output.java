...
public class Task_Output {
    ...
    @JsonPropertyDescription("The value of the Output parameter as a basic type.")
    ...
    public String toString() {
        ...
        sb.append(Task_Output.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Task_Output) == false) {
            return false;
        }
        Task_Output rhs = ((Task_Output) other);
