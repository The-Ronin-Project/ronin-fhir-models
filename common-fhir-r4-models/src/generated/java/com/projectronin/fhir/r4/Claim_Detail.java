...
public class Claim_Detail {
    ...
    private List<Claim_SubDetail> subDetail = new ArrayList<Claim_SubDetail>();
     ...
     */
    @JsonProperty("subDetail")
    public List<Claim_SubDetail> getSubDetail() {
        return subDetail;
    }
     ...
     */
    @JsonProperty("subDetail")
    public void setSubDetail(List<Claim_SubDetail> subDetail) {
    ...
    public String toString() {
        ...
        sb.append(Claim_Detail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
