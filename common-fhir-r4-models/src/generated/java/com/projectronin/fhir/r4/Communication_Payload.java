...
public class Communication_Payload {
    ...
    @JsonPropertyDescription("A communicated content (or for multi-part communications, one portion of the communication).")
    ...
    public String toString() {
        ...
        sb.append(Communication_Payload.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Communication_Payload) == false) {
            return false;
        }
        Communication_Payload rhs = ((Communication_Payload) other);
