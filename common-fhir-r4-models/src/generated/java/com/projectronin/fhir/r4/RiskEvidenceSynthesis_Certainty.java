...
public class RiskEvidenceSynthesis_Certainty {
    ...
    private List<RiskEvidenceSynthesis_CertaintySubcomponent> certaintySubcomponent = new ArrayList<RiskEvidenceSynthesis_CertaintySubcomponent>();
     ...
     */
    @JsonProperty("certaintySubcomponent")
    public List<RiskEvidenceSynthesis_CertaintySubcomponent> getCertaintySubcomponent() {
     ...
     */
    @JsonProperty("certaintySubcomponent")
    public void setCertaintySubcomponent(List<RiskEvidenceSynthesis_CertaintySubcomponent> certaintySubcomponent) {
    ...
    public String toString() {
        ...
        sb.append(RiskEvidenceSynthesis_Certainty.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RiskEvidenceSynthesis_Certainty) == false) {
            return false;
        }
        RiskEvidenceSynthesis_Certainty rhs = ((RiskEvidenceSynthesis_Certainty) other);
