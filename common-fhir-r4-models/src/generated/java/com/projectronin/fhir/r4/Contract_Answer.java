...
public class Contract_Answer {
    ...
    @JsonPropertyDescription("Response to an offer clause or question text,  which enables selection of values to be agreed to, e.g., the period of participation, the date of occupancy of a rental, warrently duration, or whether biospecimen may be used for further research.")
    ...
    public String toString() {
        ...
        sb.append(Contract_Answer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Contract_Answer) == false) {
            return false;
        }
        Contract_Answer rhs = ((Contract_Answer) other);
