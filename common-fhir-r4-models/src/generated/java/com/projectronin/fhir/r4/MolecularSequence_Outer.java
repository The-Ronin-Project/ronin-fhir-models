...
public class MolecularSequence_Outer {
    ...
    public String toString() {
        ...
        sb.append(MolecularSequence_Outer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MolecularSequence_Outer) == false) {
            return false;
        }
        MolecularSequence_Outer rhs = ((MolecularSequence_Outer) other);
