...
public class ExplanationOfBenefit_SupportingInfo {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_SupportingInfo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_SupportingInfo) == false) {
            return false;
        }
        ExplanationOfBenefit_SupportingInfo rhs = ((ExplanationOfBenefit_SupportingInfo) other);
