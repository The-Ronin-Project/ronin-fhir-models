...
public class ExplanationOfBenefit_Procedure {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_Procedure.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_Procedure) == false) {
            return false;
        }
        ExplanationOfBenefit_Procedure rhs = ((ExplanationOfBenefit_Procedure) other);
