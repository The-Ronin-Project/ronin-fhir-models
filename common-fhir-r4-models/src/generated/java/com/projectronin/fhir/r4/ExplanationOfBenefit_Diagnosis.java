...
public class ExplanationOfBenefit_Diagnosis {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_Diagnosis.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_Diagnosis) == false) {
            return false;
        }
        ExplanationOfBenefit_Diagnosis rhs = ((ExplanationOfBenefit_Diagnosis) other);
