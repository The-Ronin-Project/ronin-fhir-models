...
public class HealthcareService_AvailableTime {
    ...
    public String toString() {
        ...
        sb.append(HealthcareService_AvailableTime.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof HealthcareService_AvailableTime) == false) {
            return false;
        }
        HealthcareService_AvailableTime rhs = ((HealthcareService_AvailableTime) other);
