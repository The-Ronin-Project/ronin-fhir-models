    ...
    extends DomainResource
{
    ...
    @JsonPropertyDescription("This is a Evidence resource")
    ...
    @JsonPropertyDescription("A formal identifier that is used to identify this evidence when it is represented in other formats, or referenced in a specification, model, design or an instance.")
     ...
     */
    @JsonProperty("status")
    @JsonPropertyDescription("The status of this evidence. Enables tracking the life-cycle of the content.")
    private Evidence.Status status;
    /**
     * Base definition for all elements in a resource.
     * 
     */
    ...
    @JsonPropertyDescription("The content was developed with a focus and intent of supporting the contexts that are listed. These contexts may be general categories (gender, age, ...) or may be references to specific programs (insurance plans, studies, ...) and may be used to assist with indexing and searching for appropriate evidence instances.")
    ...
    @JsonPropertyDescription("A legal or geographic region in which the evidence is intended to be used.")
     ...
     */
    @JsonProperty("topic")
    @JsonPropertyDescription("Descriptive topics related to the content of the Evidence. Topics provide a high-level categorization grouping types of Evidences that can be useful for filtering and searching.")
    ...
    @JsonPropertyDescription("A reference to a EvidenceVariable resource that defines the exposure for the research.")
    private List<Reference> exposureVariant = new ArrayList<Reference>();
    /**
     * A reference to a EvidenceVariable resomece that defines the outcome for the research.
     * 
     */
    @JsonProperty("outcome")
    @JsonPropertyDescription("A reference to a EvidenceVariable resomece that defines the outcome for the research.")
    private List<Reference> outcome = new ArrayList<Reference>();
    @JsonIgnore
     ...
     */
    @JsonProperty("status")
    public Evidence.Status getStatus() {
        return status;
    }
     ...
     */
    @JsonProperty("status")
    public void setStatus(Evidence.Status status) {
        this.status = status;
    }
     ...
     */
    @JsonProperty("exposureVariant")
    public void setExposureVariant(List<Reference> exposureVariant) {
     ...
     */
    @JsonProperty("outcome")
    public void setOutcome(List<Reference> outcome) {
    ...
    public String toString() {
        ...
        sb.append(Evidence.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("exposureBackground");
        sb.append('=');
        sb.append(((this.exposureBackground == null)?"<null>":this.exposureBackground));
        sb.append(',');
        sb.append("exposureVariant");
        sb.append('=');
        sb.append(((this.exposureVariant == null)?"<null>":this.exposureVariant));
        sb.append(',');
        sb.append("outcome");
        sb.append('=');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.exposureVariant == null)? 0 :this.exposureVariant.hashCode()));
        result = ((result* 31)+((this.url == null)? 0 :this.url.hashCode()));
        result = ((result* 31)+((this.exposureBackground == null)? 0 :this.exposureBackground.hashCode()));
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((((((((((((((((((((((((((((((((((((super.equals(rhs)&&((this.date == rhs.date)||((this.date!= null)&&this.date.equals(rhs.date))))&&((this.note == rhs.note)||((this.note!= null)&&this.note.equals(rhs.note))))&&((this.copyright == rhs.copyright)||((this.copyright!= null)&&this.copyright.equals(rhs.copyright))))&&((this._approvalDate == rhs._approvalDate)||((this._approvalDate!= null)&&this._approvalDate.equals(rhs._approvalDate))))&&((this.approvalDate == rhs.approvalDate)||((this.approvalDate!= null)&&this.approvalDate.equals(rhs.approvalDate))))&&((this._name == rhs._name)||((this._name!= null)&&this._name.equals(rhs._name))))&&((this.jurisdiction == rhs.jurisdiction)||((this.jurisdiction!= null)&&this.jurisdiction.equals(rhs.jurisdiction))))&&((this.description == rhs.description)||((this.description!= null)&&this.description.equals(rhs.description))))&&((this.shortTitle == rhs.shortTitle)||((this.shortTitle!= null)&&this.shortTitle.equals(rhs.shortTitle))))&&((this.title == rhs.title)||((this.title!= null)&&this.title.equals(rhs.title))))&&((this._shortTitle == rhs._shortTitle)||((this._shortTitle!= null)&&this._shortTitle.equals(rhs._shortTitle))))&&((this._copyright == rhs._copyright)||((this._copyright!= null)&&this._copyright.equals(rhs._copyright))))&&((this.contact == rhs.contact)||((this.contact!= null)&&this.contact.equals(rhs.contact))))&&((this.endorser == rhs.endorser)||((this.endorser!= null)&&this.endorser.equals(rhs.endorser))))&&((this._url == rhs._url)||((this._url!= null)&&this._url.equals(rhs._url))))&&((this._description == rhs._description)||((this._description!= null)&&this._description.equals(rhs._description))))&&((this._version == rhs._version)||((this._version!= null)&&this._version.equals(rhs._version))))&&((this.outcome == rhs.outcome)||((this.outcome!= null)&&this.outcome.equals(rhs.outcome))))&&((this.identifier == rhs.identifier)||((this.identifier!= null)&&this.identifier.equals(rhs.identifier))))&&((this.editor == rhs.editor)||((this.editor!= null)&&this.editor.equals(rhs.editor))))&&((this._subtitle == rhs._subtitle)||((this._subtitle!= null)&&this._subtitle.equals(rhs._subtitle))))&&((this.relatedArtifact == rhs.relatedArtifact)||((this.relatedArtifact!= null)&&this.relatedArtifact.equals(rhs.relatedArtifact))))&&((this._date == rhs._date)||((this._date!= null)&&this._date.equals(rhs._date))))&&((this.effectivePeriod == rhs.effectivePeriod)||((this.effectivePeriod!= null)&&this.effectivePeriod.equals(rhs.effectivePeriod))))&&((this.author == rhs.author)||((this.author!= null)&&this.author.equals(rhs.author))))&&((this._title == rhs._title)||((this._title!= null)&&this._title.equals(rhs._title))))&&((this.reviewer == rhs.reviewer)||((this.reviewer!= null)&&this.reviewer.equals(rhs.reviewer))))&&((this._status == rhs._status)||((this._status!= null)&&this._status.equals(rhs._status))))&&((this._lastReviewDate == rhs._lastReviewDate)||((this._lastReviewDate!= null)&&this._lastReviewDate.equals(rhs._lastReviewDate))))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.exposureVariant == rhs.exposureVariant)||((this.exposureVariant!= null)&&this.exposureVariant.equals(rhs.exposureVariant))))&&((this.url == rhs.url)||((this.url!= null)&&this.url.equals(rhs.url))))&&((this.exposureBackground == rhs.exposureBackground)||((this.exposureBackground!= null)&&this.exposureBackground.equals(rhs.exposureBackground))))&&((this.lastReviewDate == rhs.lastReviewDate)||((this.lastReviewDate!= null)&&this.lastReviewDate.equals(rhs.lastReviewDate))))&&((this.subtitle == rhs.subtitle)||((this.subtitle!= null)&&this.subtitle.equals(rhs.subtitle))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.publisher == rhs.publisher)||((this.publisher!= null)&&this.publisher.equals(rhs.publisher))))&&((this.topic == rhs.topic)||((this.topic!= null)&&this.topic.equals(rhs.topic))))&&((this._publisher == rhs._publisher)||((this._publisher!= null)&&this._publisher.equals(rhs._publisher))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.useContext == rhs.useContext)||((this.useContext!= null)&&this.useContext.equals(rhs.useContext))))&&((this.resourceType == rhs.resourceType)||((this.resourceType!= null)&&this.resourceType.equals(rhs.resourceType))))&&((this.status == rhs.status)||((this.status!= null)&&this.status.equals(rhs.status))));
    }
    ...
    public enum Status {
        ...
        private final static Map<String, Evidence.Status> CONSTANTS = new HashMap<String, Evidence.Status>();

        static {
            for (Evidence.Status c: values()) {
        ...
        @JsonCreator
        public static Evidence.Status fromValue(String value) {
            Evidence.Status constant = CONSTANTS.get(value);
            if (constant == null) {
