...
public class ImagingStudy_Performer {
    ...
    public String toString() {
        ...
        sb.append(ImagingStudy_Performer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ImagingStudy_Performer) == false) {
            return false;
        }
        ImagingStudy_Performer rhs = ((ImagingStudy_Performer) other);
