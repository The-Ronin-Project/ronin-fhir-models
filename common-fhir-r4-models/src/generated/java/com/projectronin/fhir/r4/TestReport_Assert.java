...
public class TestReport_Assert {
     ...
     */
    @JsonProperty("result")
    @JsonPropertyDescription("The result of this assertion.")
    private TestReport_Assert.Result result;
    /**
     ...
     */
    @JsonProperty("result")
    public TestReport_Assert.Result getResult() {
        return result;
    }
     ...
     */
    @JsonProperty("result")
    public void setResult(TestReport_Assert.Result result) {
        this.result = result;
    }
    ...
    public String toString() {
        ...
        sb.append(TestReport_Assert.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TestReport_Assert) == false) {
            return false;
        }
        TestReport_Assert rhs = ((TestReport_Assert) other);
    ...
    public enum Result {
        ...
        private final static Map<String, TestReport_Assert.Result> CONSTANTS = new HashMap<String, TestReport_Assert.Result>();

        static {
            for (TestReport_Assert.Result c: values()) {
        ...
        @JsonCreator
        public static TestReport_Assert.Result fromValue(String value) {
            TestReport_Assert.Result constant = CONSTANTS.get(value);
            if (constant == null) {
