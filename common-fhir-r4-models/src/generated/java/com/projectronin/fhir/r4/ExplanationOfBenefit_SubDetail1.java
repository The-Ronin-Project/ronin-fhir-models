...
public class ExplanationOfBenefit_SubDetail1 {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_SubDetail1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_SubDetail1) == false) {
            return false;
        }
        ExplanationOfBenefit_SubDetail1 rhs = ((ExplanationOfBenefit_SubDetail1) other);
