...
public class QuestionnaireResponse_Answer {
    ...
    @JsonPropertyDescription("The answer (or one of the answers) provided by the respondent to the question.")
     ...
     */
    @JsonProperty("item")
    @JsonPropertyDescription("Nested groups and/or questions found within this particular answer.")
    ...
    public String toString() {
        ...
        sb.append(QuestionnaireResponse_Answer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
