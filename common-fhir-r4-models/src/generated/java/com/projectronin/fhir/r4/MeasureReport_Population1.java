...
public class MeasureReport_Population1 {
    ...
    public String toString() {
        ...
        sb.append(MeasureReport_Population1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MeasureReport_Population1) == false) {
            return false;
        }
        MeasureReport_Population1 rhs = ((MeasureReport_Population1) other);
