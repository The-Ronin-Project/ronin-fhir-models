...
public class MedicinalProductContraindication_OtherTherapy {
    ...
    public String toString() {
        ...
        sb.append(MedicinalProductContraindication_OtherTherapy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MedicinalProductContraindication_OtherTherapy) == false) {
            return false;
        }
        MedicinalProductContraindication_OtherTherapy rhs = ((MedicinalProductContraindication_OtherTherapy) other);
