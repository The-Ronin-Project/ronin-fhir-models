...
public class DeviceRequest_Parameter {
    ...
    public String toString() {
        ...
        sb.append(DeviceRequest_Parameter.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DeviceRequest_Parameter) == false) {
            return false;
        }
        DeviceRequest_Parameter rhs = ((DeviceRequest_Parameter) other);
