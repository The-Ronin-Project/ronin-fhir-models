...
public class Device_DeviceName {
     ...
     */
    @JsonProperty("type")
    @JsonPropertyDescription("The type of deviceName.\nUDILabelName | UserFriendlyName | PatientReportedName | ManufactureDeviceName | ModelName.")
    private Device_DeviceName.Type type;
    /**
     * Base definition for all elements in a resource.
     * 
     */
     ...
     */
    @JsonProperty("type")
    public Device_DeviceName.Type getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(Device_DeviceName.Type type) {
        this.type = type;
    }
    ...
    public String toString() {
        ...
        sb.append(Device_DeviceName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Device_DeviceName) == false) {
            return false;
        }
        Device_DeviceName rhs = ((Device_DeviceName) other);
    ...
    public enum Type {
        ...
        private final static Map<String, Device_DeviceName.Type> CONSTANTS = new HashMap<String, Device_DeviceName.Type>();

        static {
            for (Device_DeviceName.Type c: values()) {
        ...
        @JsonCreator
        public static Device_DeviceName.Type fromValue(String value) {
            Device_DeviceName.Type constant = CONSTANTS.get(value);
            if (constant == null) {
