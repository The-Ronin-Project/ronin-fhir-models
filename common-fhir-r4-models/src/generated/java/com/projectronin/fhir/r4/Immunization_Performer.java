...
public class Immunization_Performer {
    ...
    public String toString() {
        ...
        sb.append(Immunization_Performer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Immunization_Performer) == false) {
            return false;
        }
        Immunization_Performer rhs = ((Immunization_Performer) other);
