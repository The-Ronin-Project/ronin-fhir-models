...
public class ElementDefinition_Example {
    ...
    @JsonPropertyDescription("The actual value for the element, which must be one of the types allowed for this element.")
    ...
    public String toString() {
        ...
        sb.append(ElementDefinition_Example.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
