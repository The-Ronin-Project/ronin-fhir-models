...
public class Contract_Legal {
    ...
    public String toString() {
        ...
        sb.append(Contract_Legal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Contract_Legal) == false) {
            return false;
        }
        Contract_Legal rhs = ((Contract_Legal) other);
