...
public class Claim_SubDetail {
    ...
    public String toString() {
        ...
        sb.append(Claim_SubDetail.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Claim_SubDetail) == false) {
            return false;
        }
        Claim_SubDetail rhs = ((Claim_SubDetail) other);
