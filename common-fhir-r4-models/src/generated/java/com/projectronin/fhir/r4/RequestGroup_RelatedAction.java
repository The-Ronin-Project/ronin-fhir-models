...
public class RequestGroup_RelatedAction {
    ...
    public String toString() {
        ...
        sb.append(RequestGroup_RelatedAction.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RequestGroup_RelatedAction) == false) {
            return false;
        }
        RequestGroup_RelatedAction rhs = ((RequestGroup_RelatedAction) other);
