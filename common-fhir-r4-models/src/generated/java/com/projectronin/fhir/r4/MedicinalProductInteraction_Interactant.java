...
public class MedicinalProductInteraction_Interactant {
    ...
    public String toString() {
        ...
        sb.append(MedicinalProductInteraction_Interactant.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MedicinalProductInteraction_Interactant) == false) {
            return false;
        }
        MedicinalProductInteraction_Interactant rhs = ((MedicinalProductInteraction_Interactant) other);
        return ((((((this.itemReference == rhs.itemReference)||((this.itemReference!= null)&&this.itemReference.equals(rhs.itemReference)))&&((this.extension == rhs.extension)||((this.extension!= null)&&this.extension.equals(rhs.extension))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.itemCodeableConcept == rhs.itemCodeableConcept)||((this.itemCodeableConcept!= null)&&this.itemCodeableConcept.equals(rhs.itemCodeableConcept))))&&((this.modifierExtension == rhs.modifierExtension)||((this.modifierExtension!= null)&&this.modifierExtension.equals(rhs.modifierExtension))));
    }
