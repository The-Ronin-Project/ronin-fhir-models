...
public class Contract_Friendly {
    ...
    public String toString() {
        ...
        sb.append(Contract_Friendly.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Contract_Friendly) == false) {
            return false;
        }
        Contract_Friendly rhs = ((Contract_Friendly) other);
