...
public class ExplanationOfBenefit_Detail1 {
    ...
    @JsonPropertyDescription("The third-tier service adjudications for payor added services.")
    private List<ExplanationOfBenefit_SubDetail1> subDetail = new ArrayList<ExplanationOfBenefit_SubDetail1>();
     ...
     */
    @JsonProperty("subDetail")
    public List<ExplanationOfBenefit_SubDetail1> getSubDetail() {
        return subDetail;
    }
     ...
     */
    @JsonProperty("subDetail")
    public void setSubDetail(List<ExplanationOfBenefit_SubDetail1> subDetail) {
    ...
    public String toString() {
        ...
        sb.append(ExplanationOfBenefit_Detail1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ExplanationOfBenefit_Detail1) == false) {
            return false;
        }
        ExplanationOfBenefit_Detail1 rhs = ((ExplanationOfBenefit_Detail1) other);
